...
public class viewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        blue1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.aves_24);

                intent.putExtra(Intent.EXTRA_STREAM, uri);

                startActivityForResult(Intent.createChooser(intent, "compartir con"), 100);
            }
        });
        ...
        blue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://" + getPackageName() + R.raw.campana_whatsapp);
        ...
        blue3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://" + getPackageName() + R.raw.iphone_notificacion);
        ...
        blue4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://" + getPackageName() + R.raw.mario_bros_vida);
        ...
        blue5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://" + getPackageName() + R.raw.mario_coin);
    ...
    private void mostrarModalPunto() {

        android.content.SharedPreferences prefs = getSharedPreferences("puntos", MODE_PRIVATE);
        int puntos = prefs.getInt("puntos", 0);
        puntos++;
        prefs.edit().putInt("puntos", puntos).apply();
        new AlertDialog.Builder(this)
                .setTitle("¡Ganaste un punto!")
                .setMessage("Gracias por compartir el audio.\n\nTotal de puntos: " + puntos)
